...
export const dict = {
  es: {
    ...
    agendar: {
      kicker: "Agendar",
      title: "Reservá 30 minutos para revisar tu automotora.",
      sub: "Elegí un horario y contanos cómo trabajás hoy. Esto es lo que hacemos en la llamada:",
  ...
  en: {
    ...
    agendar: {
      kicker: "Book a call",
      title: "Book 30 minutes to review your dealership.",
      sub: "Pick a time and tell us how you work today. Here's what we do on the call:",
