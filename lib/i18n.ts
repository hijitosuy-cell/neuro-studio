...
export const faqsI18n = {
  es: [
    ...
    { q: "¿Trabajan fuera de Uruguay?", a: "Sí. Trabajamos con automotoras de toda la región de forma remota. Nuestra base está en Salto, Uruguay, pero el sistema y el acompañamiento funcionan igual, estés donde estés." },
  ],
  en: [
